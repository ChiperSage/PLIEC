  	...
  	<div class="wrapper">
  		...
  		<header class="main-header">
  			...
  			<a href="<?php echo base_url('admin') ?>" class="logo">
  				...
  				<span class="logo-lg"><b> </b>PLIEC</span>
  			</a>
  					...
  					<ul class="nav navbar-nav">
  						...
  						<li class="dropdown user user-menu">
  							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
  								<img src="<?php echo base_url() ?>vendor/almasaeed2010/adminlte/dist/img/user-blank.jpg" class="user-image" alt="User Image">
         ...
         <li>
          <a href="<?php echo base_url('article/index/0/?type=page') ?>">
