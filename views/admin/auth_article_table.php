	...
	<div class="col-xs-12">
		...
		<div class="box box-info">
			<div class="box-header">
				...
				<a class="btn btn-default" href="<?php echo base_url('author/create') ?>">Add New</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
					...
					<tbody>
						<?php $i=$this->uri->segment(3); foreach ($articles as $value) { $i++ ?>
							<tr>
								...
								<td> <strong><?php echo anchor('author/update/'.$value->ID,$value->post_title) ?></strong> </td>
								...
								<td>
									<a href="<?php echo base_url('author/update/'.$value->ID) ?>"><i class="fa fa-edit"></i></a>
								</td>
